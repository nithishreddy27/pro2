...
<div>
            ...
            <h1 className="text-white ml-80 mt-8 text-5xl text-[25px]">
                ...
                <h6 className="text-white ml-80 mt-1 text-[16px] ">{profile?.role}</h6>
            </div>
                ...
                <img className="w-40 m-10 rounded-lg"
                  ...
                  {skills?.filter((skills)=>skills?.enabled)?.length>0&&(
                    ...
                    <div className="border-b-2 border-white m-6 p-3">
                      <h1 className="font-medium text-lg text-white text-[16px] ">SKILLS</h1>
                     {skills?.filter(skills=>skills?.enabled===true).map((item)=>(
                           <div>
                           <h1 className="font-normal   text-white text-[12px]">{item.name}</h1>
                           <li className="text-sm ml-4 text-white text-[12px]">{item.level}</li>
                         </div>
                     ))}
                  </div>
       ...
       {social?.filter((social)=>social?.enabled)?.length>0 &&(
         <div>
         <div className="border-b-2 border-white m-6 p-3">
         <h1 className="font-medium text-lg text-white text-[16px]">SOCIAL</h1>
        {social?.filter(social=>social?.enabled===true).map((item)=>(
         ...
         />
          <Link href={item.url}>
           <h1 className="ml-4 text-white text-[12px]">{item.username}</h1>
         </Link>
              ...
              {awards?.filter((awards)=>awards?.enabled)?.length>0 &&(
                 <div>
                 <div className="border-b-2 border-white m-6 p-3">
                 <h1 className="font-medium text-lg text-white text-[16px]">AWARDS</h1>
                {awards?.filter(awards=>awards?.enabled===true).map((item)=>(
                                           <div className="m-2">
                                           <h1 className="text-white text-[12px]">{item.awarder}</h1>
                                           <li className="text-white text-sm ml-4 text-[12px]">{item.awarder}</li>
                                           </div>
                ))}
                 </div>
                 </div>
                  ...
                  {hobbies?.filter((hobbies)=>hobbies?.enabled)?.length>0 &&(
                    <div>
                    <div className="border-b-2 border-white m-6 p-3">
                    <h1 className="font-medium text-lg text-white text-[16px]">HOBBIES</h1>
                  {hobbies?.filter(hobbies?.enabled===true).map((item)=>(
                     <div className="m-2">
                ...
                <div className="col-span-2">
                 {objective &&(
                     ...
                     <div className="border-b-4 border-black m-4 p-5">
                         <h1 className="font-medium text-lg text-gray-600 text-[16px]">ABOUT ME</h1>
                         <p className="text-sm font-medium pt-1 text-[12px]">{objective}</p>
                         </div>
                     </div>
                     </div>
                 )}
                   {work?.filter((work)=>work?.enabled)?.length>0 &&(
                     ...
                     <h1 className="font-medium text-lg text-gray-600 text-[16px]">WORK EXPERIENCE</h1>
                  {work?.filter(work?.enabled===true).map((item)=>(
                     <div className="p-1">
                     <h1 className="font-medium ml-4 text-lg text-[12px]">{item.company}</h1>
                     <h2 className="font-semibold text-xs ml-4 text-[12px]">
                       {item.from} - {item.to}
                     </h2>
                     <li className="ml-10 list-disc font-semibold text-[12px]">
                       {item.designation}
                     </li>
                     <li className="ml-10 list-disc font-semibold text-[12px]">
                       {item.website}
                    ...
                    {education?.filter((education)=>education?.enabled)?.length>0 &&(
                        <div>
                        <div  className="border-b-4 border-black m-4 p-2">
                        <h1 className="font-medium text-lg text-gray-600 text-[16px]">EDUCATION</h1>
                        {education?.filter(education?.enabled===true).map((item)=>(
                              <div>
                              <h1 className="font-medium ml-6 text-[12px]">{item.institution}</h1>
                              <h6 className="text-xs font-semibold ml-6 text-[12px]">
                                {item.startDate} - {item.endDate}
                              </h6>
                              <li className="ml-8 font-semibold text-[12px]">{item.fieldOfStudy}</li>
                            </div>
                        ))}
                   ...
                   {awards?.filter((awards)=>awards?.enabled)?.length>0 &&(
                     <div>
                     <div  className="border-b-4 border-black m-4 p-2">
                     <h1 className="font-medium text-lg text-gray-600 text-[16px]">AWARDS</h1>
                     {awards?.filter(awards?.enabled===true).map((item)=>(
                          <div>
                          <h1 className="font-medium ml-6 text-[12px]">{item.title}</h1>
                          <h6 className="text-xs font-semibold ml-6 text-[12px]">
                            {item.date}
                          </h6>
                          <li className="ml-8 font-semibold text-[12px]">{item.summary.data}</li>
                        </div>
                     ))}
